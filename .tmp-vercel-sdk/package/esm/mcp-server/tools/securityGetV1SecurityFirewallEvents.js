...
export const tool$securityGetV1SecurityFirewallEvents = {
...
Retrieve firewall actions for a project`,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await securityGetV1SecurityFirewallEvents(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
