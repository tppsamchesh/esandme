...
export const tool$integrationsGetBillingPlans = {
...
Get a list of billing plans for an integration and product.`,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await integrationsGetBillingPlans(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
