...
export const tool$marketplaceUpdateInstallation = {
...
This endpoint updates an integration installation.`,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await marketplaceUpdateInstallation(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
