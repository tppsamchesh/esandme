...
export const tool$bulkRedirectsGetRedirects = {
...
Get the version history for a project's bulk redirects`,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await bulkRedirectsGetRedirects(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
