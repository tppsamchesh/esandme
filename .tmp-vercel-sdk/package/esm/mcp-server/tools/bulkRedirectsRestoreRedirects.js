...
export const tool$bulkRedirectsRestoreRedirects = {
...
Restores the provided redirects in the staging version to the value in the production version. If no production version exists, removes the redirects from staging.`,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await bulkRedirectsRestoreRedirects(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
