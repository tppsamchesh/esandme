import { RunCommandAcceptEnum } from "../funcs/sandboxesRunCommand.js";
...
export declare class Sandboxes extends ClientSDK {
     ...
     */
    listSnapshots(request: ListSnapshotsRequest, options?: RequestOptions): Promise<ListSnapshotsResponseBody>;
    /**
     * Get a sandbox
     *
     * @remarks
     ...
     */
    getSandbox(request: GetSandboxRequest, options?: RequestOptions): Promise<GetSandboxResponseBody>;
    /**
     * List commands
     *
     * @remarks
     ...
     */
    listCommands(request: ListCommandsRequest, options?: RequestOptions): Promise<ListCommandsResponseBody>;
    /**
     * Execute a command
     *
     * @remarks
     ...
     */
    runCommand(request: RunCommandRequest, options?: RequestOptions & {
     ...
     */
    killCommand(request: KillCommandRequest, options?: RequestOptions): Promise<KillCommandResponseBody>;
    /**
     * Stop a sandbox
     *
     * @remarks
     ...
     */
    stopSandbox(request: StopSandboxRequest, options?: RequestOptions): Promise<StopSandboxResponseBody>;
    /**
     ...
     */
    extendSandboxTimeout(request: ExtendSandboxTimeoutRequest, options?: RequestOptions): Promise<ExtendSandboxTimeoutResponseBody>;
    /**
     ...
     */
    updateNetworkPolicy(request: UpdateNetworkPolicyRequest, options?: RequestOptions): Promise<UpdateNetworkPolicyResponseBody>;
    /**
     * Get a command
     *
     * @remarks
     ...
     */
    getCommand(request: GetCommandRequest, options?: RequestOptions): Promise<GetCommandResponseBody>;
    /**
     * Stream command logs
     *
     * @remarks
     ...
     */
    getCommandLogs(request: GetCommandLogsRequest, options?: RequestOptions): Promise<JsonLStream<GetCommandLogsResponseBody>>;
    /**
     * Read a file
     *
     * @remarks
     ...
     */
    readFile(request: ReadFileRequest, options?: RequestOptions): Promise<ReadableStream<Uint8Array>>;
    /**
     * Create a directory
     *
     * @remarks
     ...
     */
    createDirectory(request: CreateDirectoryRequest, options?: RequestOptions): Promise<CreateDirectoryResponseBody>;
    /**
     * Write files
     *
     * @remarks
     ...
     */
    writeFiles(request: WriteFilesRequest, options?: RequestOptions): Promise<WriteFilesResponseBody>;
    /**
     * Get a snapshot
     *
     * @remarks
     ...
     */
    getSnapshot(request: GetSnapshotRequest, options?: RequestOptions): Promise<GetSnapshotResponseBody>;
    /**
     * Delete a snapshot
     *
     * @remarks
     ...
     */
    deleteSnapshot(request: DeleteSnapshotRequest, options?: RequestOptions): Promise<DeleteSnapshotResponseBody>;
    /**
     * Create a snapshot
     *
     * @remarks
     ...
     */
    createSnapshot(request: CreateSnapshotRequest, options?: RequestOptions): Promise<CreateSnapshotResponseBody>;
}
