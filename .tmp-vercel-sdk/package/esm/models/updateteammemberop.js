...
export const UpdateTeamMemberRequestBody$inboundSchema = z.object({
    ...
    projects: types.optional(z.array(z.lazy(() => UpdateTeamMemberProjects$inboundSchema))),
    joinedFrom: types.optional(z.lazy(() => UpdateTeamMemberJoinedFrom$inboundSchema)),
});
/** @internal */
