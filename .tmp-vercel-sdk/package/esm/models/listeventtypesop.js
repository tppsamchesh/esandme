...
/** @internal */
export const ListEventTypesRequest$inboundSchema = z.object({
    teamId: types.optional(types.string()),
    slug: types.optional(types.string()),
});
/** @internal */
export const ListEventTypesRequest$outboundSchema = z.object({
    teamId: z.string().optional(),
    slug: z.string().optional(),
});
export function listEventTypesRequestToJSON(listEventTypesRequest) {
    return JSON.stringify(ListEventTypesRequest$outboundSchema.parse(listEventTypesRequest));
}
export function listEventTypesRequestFromJSON(jsonString) {
    return safeParse(jsonString, (x) => ListEventTypesRequest$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'ListEventTypesRequest' from JSON`);
}
/** @internal */
export const ListEventTypesName$inboundSchema = z.nativeEnum(ListEventTypesName);
/** @internal */
export const ListEventTypesName$outboundSchema = ListEventTypesName$inboundSchema;
/** @internal */
export const Types$inboundSchema = z
    .object({
...
/** @internal */
export const Types$outboundSchema = z.object({
    replacedBy: z.array(z.string()),
    deprecated: z.boolean(),
    name: ListEventTypesName$outboundSchema,
    description: z.string(),
});
export function typesToJSON(types) {
    return JSON.stringify(Types$outboundSchema.parse(types));
}
export function typesFromJSON(jsonString) {
    return safeParse(jsonString, (x) => Types$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'Types' from JSON`);
}
/** @internal */
export const ListEventTypesResponseBody$inboundSchema = z.object({
    types: z.array(z.lazy(() => Types$inboundSchema)),
});
/** @internal */
export const ListEventTypesResponseBody$outboundSchema = z.object({
    types: z.array(z.lazy(() => Types$outboundSchema)),
});
export function listEventTypesResponseBodyToJSON(listEventTypesResponseBody) {
    return JSON.stringify(ListEventTypesResponseBody$outboundSchema.parse(listEventTypesResponseBody));
}
export function listEventTypesResponseBodyFromJSON(jsonString) {
    return safeParse(jsonString, (x) => ListEventTypesResponseBody$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'ListEventTypesResponseBody' from JSON`);
}
//# sourceMappingURL=listeventtypesop.js.map