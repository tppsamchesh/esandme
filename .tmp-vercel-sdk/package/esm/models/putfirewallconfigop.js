...
/** @internal */
export const PutFirewallConfigValue$inboundSchema = smartUnion([types.string(), z.array(types.string()), types.number()]);
/** @internal */
...
/** @internal */
export const PutFirewallConfigLogHeadersSecurity2$outboundSchema = PutFirewallConfigLogHeadersSecurity2$inboundSchema;
/** @internal */
...
/** @internal */
export const PutFirewallConfigRulesLogHeaders$outboundSchema = smartUnion([
    z.array(z.string()),
    PutFirewallConfigLogHeadersSecurity2$outboundSchema,
]);
export function putFirewallConfigRulesLogHeadersToJSON(putFirewallConfigRulesLogHeaders) {
    return JSON.stringify(PutFirewallConfigRulesLogHeaders$outboundSchema.parse(putFirewallConfigRulesLogHeaders));
}
...
/** @internal */
export const PutFirewallConfigLogHeaders2$outboundSchema = PutFirewallConfigLogHeaders2$inboundSchema;
/** @internal */
...
/** @internal */
export const PutFirewallConfigRulesSecurityLogHeaders$outboundSchema = smartUnion([
    z.array(z.string()),
    PutFirewallConfigLogHeaders2$outboundSchema,
]);
export function putFirewallConfigRulesSecurityLogHeadersToJSON(putFirewallConfigRulesSecurityLogHeaders) {
    return JSON.stringify(PutFirewallConfigRulesSecurityLogHeaders$outboundSchema.parse(putFirewallConfigRulesSecurityLogHeaders));
}
