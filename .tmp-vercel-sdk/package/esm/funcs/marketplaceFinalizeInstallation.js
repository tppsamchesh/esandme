...
import { FinalizeInstallationRequest$outboundSchema, } from "../models/finalizeinstallationop.js";
 ...
 */
export function marketplaceFinalizeInstallation(client, request, options) {
    return new APIPromise($do(client, request, options));
}
async function $do(client, request, options) {
    const parsed = safeParse(request, (value) => FinalizeInstallationRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const path = pathToFunc("/v1/installations/{integrationConfigurationId}/billing/finalize")(pathParams);
...
//# sourceMappingURL=marketplaceFinalizeInstallation.js.map