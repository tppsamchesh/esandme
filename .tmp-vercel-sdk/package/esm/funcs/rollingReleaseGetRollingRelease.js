...
import { GetRollingReleaseRequest$outboundSchema, GetRollingReleaseResponseBody$inboundSchema, } from "../models/getrollingreleaseop.js";
 ...
 */
export function rollingReleaseGetRollingRelease(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const path = pathToFunc("/v1/projects/{idOrName}/rolling-release")(pathParams);
    ...
    const [result] = await M.match(M.json(200, GetRollingReleaseResponseBody$inboundSchema), M.fail([400, 401, 403, 404, "4XX"]), M.fail("5XX"))(response, req);
    if (!result.ok) {
