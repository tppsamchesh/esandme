...
import { ConnectIntegrationResourceToProjectRequest$outboundSchema, } from "../models/connectintegrationresourcetoprojectop.js";
 ...
 */
export function integrationsConnectIntegrationResourceToProject(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const path = pathToFunc("/v1/integrations/installations/{integrationConfigurationId}/resources/{resourceId}/connections")(pathParams);
    ...
    const [result] = await M.match(M.nil(201, z.void()), M.fail([400, 401, 403, 404, "4XX"]), M.fail("5XX"))(response, req);
    if (!result.ok) {
        return [result, { status: "complete", request: req, response }];
    }
    return [result, { status: "complete", request: req, response }];
}
//# sourceMappingURL=integrationsConnectIntegrationResourceToProject.js.map