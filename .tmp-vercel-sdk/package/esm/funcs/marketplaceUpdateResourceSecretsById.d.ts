 ...
 */
export declare function marketplaceUpdateResourceSecretsById(client: VercelCore, request: UpdateResourceSecretsByIdRequest, options?: RequestOptions): APIPromise<Result<void, VercelError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
