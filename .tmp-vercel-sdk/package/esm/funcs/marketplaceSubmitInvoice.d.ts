 ...
 */
export declare function marketplaceSubmitInvoice(client: VercelCore, request: SubmitInvoiceRequest, options?: RequestOptions): APIPromise<Result<SubmitInvoiceResponseBody, VercelError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
