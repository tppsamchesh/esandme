...
import { DeleteRollingReleaseConfigRequest$outboundSchema, DeleteRollingReleaseConfigResponseBody$inboundSchema, } from "../models/deleterollingreleaseconfigop.js";
 ...
 */
export function rollingReleaseDeleteRollingReleaseConfig(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, DeleteRollingReleaseConfigResponseBody$inboundSchema), M.fail([400, 401, 403, 404, "4XX"]), M.fail("5XX"))(response, req);
    if (!result.ok) {
