...
import { GetRollingReleaseConfigRequest$outboundSchema, GetRollingReleaseConfigResponseBody$inboundSchema, } from "../models/getrollingreleaseconfigop.js";
 ...
 */
export function rollingReleaseGetRollingReleaseConfig(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, GetRollingReleaseConfigResponseBody$inboundSchema), M.fail([400, 401, 403, 404, "4XX"]), M.fail("5XX"))(response, req);
    if (!result.ok) {
