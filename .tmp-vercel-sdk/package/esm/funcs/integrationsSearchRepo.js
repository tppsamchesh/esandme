 ...
 */
export function integrationsSearchRepo(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, SearchRepoResponseBody$inboundSchema), M.fail([400, 401, 403, 404, 429, "4XX"]), M.fail([500, "5XX"]))(response, req);
    if (!result.ok) {
